 ...
 */
#if !HAS_GRAPHICAL_LCD && defined(LCD_CONTRAST_INIT_OVERRIDE)
  #undef LCD_CONTRAST_INIT_OVERRIDE
#endif

#ifndef LCD_CONTRAST_INIT_OVERRIDE
...
#ifdef LCD_CONTRAST_INIT_OVERRIDE
  #define _LCD_CONTRAST_INIT = LCD_CONTRAST_INIT_OVERRIDE
#endif
